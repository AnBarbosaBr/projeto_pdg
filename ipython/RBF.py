...
class RBFClassifier(RBFBase):
    ...
    def __init__(self, number_of_centers, algorithm, random_state=42):
        ...
        Keyword Arguments:
            ...
            random_state {int} -- Random state, to be used with the internal algorithms (default: {42})
        """        
        super(RBFClassifier, self).__init__(number_of_centers, algorithm, random_state)

class RBFRegressor(RBFBase):
    def __init__(self, number_of_centers, algorithm, random_state=42):
        """[summary]
        ...
        Keyword Arguments:
            ...
            random_state {int} -- Random state, to be used with the internal algorithms (default: {42})
        """        
        super(RBFRegressor, self).__init__(number_of_centers, algorithm, random_state)
